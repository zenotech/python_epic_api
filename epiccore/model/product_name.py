...
class ProductName(ModelNormal):
    ...
    attribute_map = {
        ...
        'small_print': 'small_print',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, description, small_print, *args, **kwargs):  # noqa: E501
