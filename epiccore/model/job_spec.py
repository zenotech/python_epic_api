...
class JobSpec(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, application_version, tasks, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            tasks ([JobTaskSpec]): List of task definitions that make up this job
