...
class JobArraySpec(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'jobs': ([JobDataBinding],),  # noqa: E501
            'name': (str,),  # noqa: E501
            'common_data': (DataSpec,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'jobs': 'jobs',  # noqa: E501
        'name': 'name',  # noqa: E501
        'common_data': 'common_data',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, config, jobs, *args, **kwargs):  # noqa: E501
        """JobArraySpec - a model defined in OpenAPI

        Args:
            config (JobConfiguration):
            jobs ([JobDataBinding]): List of job specs to launch
        ...
        Keyword Args:
            ...
            name (str): Name of job array - only required for more than one job. [optional] if omitted the server will use the default value of "Job Array"  # noqa: E501
            common_data (DataSpec): [optional]  # noqa: E501
        """
