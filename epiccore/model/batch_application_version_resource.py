...
class BatchApplicationVersionResource(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'resources': ([BatchQueueDetails],),  # noqa: E501
        }
    ...
    def __init__(self, resources, *args, **kwargs):  # noqa: E501
        """BatchApplicationVersionResource - a model defined in OpenAPI

        Args:
            resources ([BatchQueueDetails]): List of resources available that are capable of running the given application version
