...
class License(ModelNormal):
    ...
    allowed_values = {
        ('license_type',): {
            'ZENOTECH_ZCFD': "zenotech_zcfd",
            'ZENOTECH_ZCAD': "zenotech_zcad",
            'ANSYS': "ansys",
        },
    }
    ...
    attribute_map = {
        'license_type': 'license_type',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, license_type, display_name, *args, **kwargs):  # noqa: E501
