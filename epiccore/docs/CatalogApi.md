...
> InlineResponse2003 catalog_desktop_applications_list(limit=limit, offset=offset)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | [**str**](.md)| A UUID string identifying this efs access point app. | 
...
> InlineResponse2003 catalog_viz_applications_list(limit=limit, offset=offset)
...
# **catalog_viz_list**
> InlineResponse2002 catalog_viz_list(limit=limit, offset=offset)
...
> InlineResponse2004 catalog_viznodetype_read(viz_application_version_id, limit=limit, offset=offset)
