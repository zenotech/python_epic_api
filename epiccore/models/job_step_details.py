...
class JobStepDetails(BaseModel):
    """
    JobStepDetails
    """ # noqa: E501
    ...
    logs: Optional[JobLog] = None
    __properties: ClassVar[List[str]] = ["id", "parent_job", "run_if_previous_step_fails", "step_name", "node_count", "num_tasks", "tasks_per_node", "threads_per_task", "max_runtime", "status", "exit_code", "start", "end", "wallclock", "logs"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "logs": JobLog.from_dict(obj.get("logs")) if obj.get("logs") is not None else None
        })
        return _obj
