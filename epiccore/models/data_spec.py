...
class DataSpec(object):
    ...
    @property
    def path(self):
        """Gets the path of this DataSpec.  # noqa: E501

        Path to the folder containing the data for this job  # noqa: E501

        :return: The path of this DataSpec.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this DataSpec.

        Path to the folder containing the data for this job  # noqa: E501

        :param path: The path of this DataSpec.  # noqa: E501
        :type path: str
        """
