...
class JobClusterSpec(BaseModel):
    """
    Cluster configuration to launch the job on
    """ # noqa: E501
    queue_code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Queue code of cluster queue to run this job on")
    __properties: ClassVar[List[str]] = ["queue_code"]
