...
class JobLog(BaseModel):
    ...
    last_update: Optional[StrictStr] = Field(default=None, description="Last time the logs were updated")
    __properties: ClassVar[List[str]] = ["stdout", "stderr", "app", "last_update"]
