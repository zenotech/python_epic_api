...
class CatalogApplicationsList200Response(BaseModel):
    """
    ...
    results: List[BatchApplicationList]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "results": [BatchApplicationList.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
