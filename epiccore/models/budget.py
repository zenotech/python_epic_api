...
class Budget(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["monthly_limit"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.monthly_limit:
            _dict['monthly_limit'] = self.monthly_limit.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "monthly_limit": MonthlyLimit.from_dict(obj.get("monthly_limit")) if obj.get("monthly_limit") is not None else None
        })
        return _obj
