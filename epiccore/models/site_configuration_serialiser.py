...
class SiteConfigurationSerialiser(object):
    ...
    def __init__(self, application_configuration=None, environment_script=None, env_variables=None, created=None, modified=None, local_vars_configuration=None):  # noqa: E501
