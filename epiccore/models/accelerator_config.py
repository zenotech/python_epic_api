...
class AcceleratorConfig(BaseModel):
    ...
    acc_class: Annotated[str, Field(min_length=1, strict=True, max_length=100)]
    quantity: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]] = None
    description: Optional[Annotated[str, Field(strict=True, max_length=255)]] = None
    __properties: ClassVar[List[str]] = ["name", "acc_class", "quantity", "description"]
