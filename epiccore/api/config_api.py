...
class ConfigApi:
    ...
    def config_read(
        ...
        _param = self._config_read_serialize(
            app_code=app_code,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SiteConfigurationSerialiser",
        }
    ...
    @validate_call
    def config_read_with_http_info(
        self,
        app_code: StrictStr,
        queue_code: StrictStr,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SiteConfigurationSerialiser]:
        """config_read
    ...
    @validate_call
    def config_read_without_preload_content(
        self,
        app_code: StrictStr,
        queue_code: StrictStr,
        _request_timeout: Union[
    ...
    def _config_read_serialize(
        ...
        if app_code is not None:
            _path_params['app_code'] = app_code
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/config/{app_code}/{queue_code}/',
