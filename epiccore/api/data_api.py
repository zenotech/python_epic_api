...
class DataApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.data_folder_list = Endpoint(
            settings={
                'response_type': (InlineResponse2006,),
                'auth': [
                    'Bearer'
                ],
                'endpoint_path': '/data/folder/',
                'operation_id': 'data_folder_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__data_folder_list
        )

        def __data_folder_read(
            self,
            id,
            **kwargs
        ):
        ...
        self.data_folder_read = Endpoint(
            settings={
                'response_type': (FolderDetails,),
                'auth': [
                    'Bearer'
                ],
                'endpoint_path': '/data/folder/{id}/',
                'operation_id': 'data_folder_read',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
