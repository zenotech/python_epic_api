...
class ProfileApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.profile_settings_list = Endpoint(
            settings={
                'response_type': (ProfileSummary,),
                'auth': [
                    'Bearer'
                ],
                'endpoint_path': '/profile/settings/',
                'operation_id': 'profile_settings_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__profile_settings_list
        )
