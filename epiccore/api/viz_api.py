...
class VizApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.viz_quote = Endpoint(
            settings={
                'response_type': (PriceQuote,),
                'auth': [
                    'Bearer'
                ],
                'endpoint_path': '/viz/quote/',
                'operation_id': 'viz_quote',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.viz_read = Endpoint(
            settings={
                'response_type': (DesktopNode,),
                'auth': [
                    'Bearer'
                ],
                'endpoint_path': '/viz/{id}/',
                'operation_id': 'viz_read',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
