...
class BatchJobSpec(object):
    ...
    def __init__(self, application_version=None, project=None, tasks=None, local_vars_configuration=None):  # noqa: E501
        """BatchJobSpec - a model defined in OpenAPI"""  # noqa: E501
    ...
    def application_version(self):
        """Gets the application_version of this BatchJobSpec.  # noqa: E501

        ID of the application_version to launch. Valid values are obtained from the catalog/applications/ endpoint  # noqa: E501

        :return: The application_version of this BatchJobSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def application_version(self, application_version):
        """Sets the application_version of this BatchJobSpec.

        ID of the application_version to launch. Valid values are obtained from the catalog/applications/ endpoint  # noqa: E501

        :param application_version: The application_version of this BatchJobSpec.  # noqa: E501
        :type: int
        """
    ...
    @property
    def project(self):
        """Gets the project of this BatchJobSpec.  # noqa: E501

        Project ID to bill this job against  # noqa: E501

        :return: The project of this BatchJobSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def project(self, project):
        """Sets the project of this BatchJobSpec.

        Project ID to bill this job against  # noqa: E501

        :param project: The project of this BatchJobSpec.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def tasks(self):
        """Gets the tasks of this BatchJobSpec.  # noqa: E501

        List of task definitions that make up this job  # noqa: E501

        :return: The tasks of this BatchJobSpec.  # noqa: E501
        :rtype: list[BatchJobTaskSpec]
        """
        return self._tasks

    @tasks.setter
    def tasks(self, tasks):
        """Sets the tasks of this BatchJobSpec.

        List of task definitions that make up this job  # noqa: E501

        :param tasks: The tasks of this BatchJobSpec.  # noqa: E501
        :type: list[BatchJobTaskSpec]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchJobSpec):
            return False
