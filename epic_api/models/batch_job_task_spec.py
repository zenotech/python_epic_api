...
class BatchJobTaskSpec(object):
    ...
    def __init__(self, reference=None, partitions=None, runtime=None, task_distribution=None, hyperthreading=True, local_vars_configuration=None):  # noqa: E501
        """BatchJobTaskSpec - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def reference(self):
        """Gets the reference of this BatchJobTaskSpec.  # noqa: E501

        A reference to help you identify this task  # noqa: E501

        :return: The reference of this BatchJobTaskSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def reference(self, reference):
        """Sets the reference of this BatchJobTaskSpec.

        A reference to help you identify this task  # noqa: E501

        :param reference: The reference of this BatchJobTaskSpec.  # noqa: E501
        :type: str
        """
    ...
    @property
    def partitions(self):
        """Gets the partitions of this BatchJobTaskSpec.  # noqa: E501

        How many partitions/tasks will this task be submitted as.  # noqa: E501

        :return: The partitions of this BatchJobTaskSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def partitions(self, partitions):
        """Sets the partitions of this BatchJobTaskSpec.

        How many partitions/tasks will this task be submitted as.  # noqa: E501

        :param partitions: The partitions of this BatchJobTaskSpec.  # noqa: E501
        :type: int
        """
    ...
    @property
    def runtime(self):
        """Gets the runtime of this BatchJobTaskSpec.  # noqa: E501

        Maximum runtime for this task in whole hours.  # noqa: E501

        :return: The runtime of this BatchJobTaskSpec.  # noqa: E501
        :rtype: int
        """
    ...
    def runtime(self, runtime):
        """Sets the runtime of this BatchJobTaskSpec.

        Maximum runtime for this task in whole hours.  # noqa: E501

        :param runtime: The runtime of this BatchJobTaskSpec.  # noqa: E501
        :type: int
        """
    ...
    def task_distribution(self):
        """Gets the task_distribution of this BatchJobTaskSpec.  # noqa: E501

        How should the partitions be distributed on the HPC cluster  # noqa: E501

        :return: The task_distribution of this BatchJobTaskSpec.  # noqa: E501
        :rtype: str
        """
    ...
    def task_distribution(self, task_distribution):
        """Sets the task_distribution of this BatchJobTaskSpec.

        How should the partitions be distributed on the HPC cluster  # noqa: E501

        :param task_distribution: The task_distribution of this BatchJobTaskSpec.  # noqa: E501
        :type: str
        """
    ...
    def hyperthreading(self):
        """Gets the hyperthreading of this BatchJobTaskSpec.  # noqa: E501

        Make use of hyperthreaded core where available  # noqa: E501

        :return: The hyperthreading of this BatchJobTaskSpec.  # noqa: E501
        :rtype: bool
        """
    ...
    def hyperthreading(self, hyperthreading):
        """Sets the hyperthreading of this BatchJobTaskSpec.

        Make use of hyperthreaded core where available  # noqa: E501

        :param hyperthreading: The hyperthreading of this BatchJobTaskSpec.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchJobTaskSpec):
            return False
