...
*CatalogApi* | [**catalog_applications_versions_list**](docs/CatalogApi.md#catalog_applications_versions_list) | **GET** /catalog/applications/{app_pk}/versions/ | 
*CatalogApi* | [**catalog_applications_versions_read**](docs/CatalogApi.md#catalog_applications_versions_read) | **GET** /catalog/applications/{app_pk}/versions/{id}/ | 
*CatalogApi* | [**catalog_applications_versions_resources_list**](docs/CatalogApi.md#catalog_applications_versions_resources_list) | **GET** /catalog/applications/{app_pk}/versions/{app_version_pk}/resources/ | 
*CatalogApi* | [**catalog_applications_versions_resources_read**](docs/CatalogApi.md#catalog_applications_versions_resources_read) | **GET** /catalog/applications/{app_pk}/versions/{app_version_pk}/resources/{id}/ | 
...
## Documentation For Models
 ...
 - [BatchApplicationVersionResource](docs/BatchApplicationVersionResource.md)
 - [BatchApplicationVersionResourceDetails](docs/BatchApplicationVersionResourceDetails.md)
 - [BatchApplicationVersionSerializerAPI](docs/BatchApplicationVersionSerializerAPI.md)
...
If the OpenAPI document is large, imports in epiccore.apis and epiccore.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from epiccore.api.default_api import DefaultApi`
- `from epiccore.model.pet import Pet`
